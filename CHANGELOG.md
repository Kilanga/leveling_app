...
- Internationalisation: prise en charge FR/EN avec détection automatique de la langue du navigateur (Accept-Language header).
- Interface principale: libellés de navigation et métadonnées SEO branchés sur i18n pour affichage cohérent selon la langue détectée du navigateur.
