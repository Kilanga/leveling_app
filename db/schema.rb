...
ActiveRecord::Schema[8.1].define(version: 2026_07_06_120000) do
  ...
  create_table "quests", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.text "description"
    t.string "difficulty", default: "E", null: false
    ...
    t.index ["difficulty"], name: "index_quests_on_difficulty"
    t.index ["signature"], name: "index_quests_on_signature"
  end

  create_table "season_pass_claims", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["season_id"], name: "index_season_pass_claims_on_season_id"
    t.index ["user_id", "season_id", "tier", "track"], name: "index_season_pass_claims_uniqueness", unique: true
    t.index ["user_id"], name: "index_season_pass_claims_on_user_id"
  end
  ...
  create_table "system_quest_assignments", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["quest_id"], name: "index_system_quest_assignments_on_quest_id"
    t.index ["user_id", "assigned_on"], name: "index_system_quest_assignments_on_user_id_and_assigned_on"
    t.index ["user_id", "quest_id", "assigned_on"], name: "index_system_assignments_uniqueness", unique: true
    t.index ["user_id"], name: "index_system_quest_assignments_on_user_id"
  end
  ...
  create_table "user_season_passes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["season_id"], name: "index_user_season_passes_on_season_id"
    t.index ["user_id", "season_id"], name: "index_user_season_passes_on_user_id_and_season_id", unique: true
  ...
  create_table "user_seasons", force: :cascade do |t|
    ...
    t.index ["season_id", "user_id"], name: "index_user_seasons_on_season_id_and_user_id", unique: true
    t.index ["season_id", "xp"], name: "index_user_seasons_on_season_id_and_xp"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.date "daily_login_last_claimed_on"
  ...
  add_foreign_key "season_pass_claims", "seasons"
  add_foreign_key "season_pass_claims", "users"
  ...
  add_foreign_key "system_quest_assignments", "quests"
  add_foreign_key "system_quest_assignments", "users"
  ...
  add_foreign_key "user_season_passes", "seasons"
